...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-11-2023 a las 12:45:11
...
INSERT INTO `datos_personales` (`n_documento`, `nombre`, `apellido`, `edad`) VALUES
...
INSERT INTO `producto` (`id_producto`, `seccion`, `producto`, `origen`, `importada`, `precio`) VALUES
...
('ar85', 'JUGETE PARA ADULTO', 'dildo femnil', 'jaider', 'china', 5);
